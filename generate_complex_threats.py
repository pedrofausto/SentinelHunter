...
def generate_complex_threats(output_file, num_incidents=10):
    ...
    for i in range(num_incidents):
        ...
        start_time = now + timedelta(seconds=(i * 10))
        
        # Create a single ID for this entire chain to exercise the unification logic
        incident_id = f"OT-{uuid.uuid4().hex[:8]}"
...
if __name__ == "__main__":
    generate_complex_threats("samples/wazuh_mixed_complex.jsonl", num_incidents=50)
